...
steps 1 and 2 are what we've been doing. to do 3, go to tools > version control > project setup. 
...
once you've done this, a few things will happen. most notably, you now have a .gitignore file in your project; by default, this will ignore `.Rproj.user`, `.Rhistory`, `.RData`, and `.Ruserdata`. You can add things to be ignored if you want.
