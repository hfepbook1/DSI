...
This is the secode module in the [Data Wrangling I](topic_data_wrangling_i.html) topic; the relevant slack channel is [here](https://p8105-fall2017.slack.com/messages/C75HFE38U).
...
Start by figuring out how this example fits in with what you've done and plan to do -- you may want to start a whole new directory and R Project practice, but I'd suggest adding a new R Markdown file to the project we started last time. 
...
The code that I produced working examples in lecture is [here](./code/data_wrangling_i.zip).
