...
The [Data Wrangling I](data_wrangling_i.html) slack channel is [here](https://p8105-fall2017.slack.com/messages/C75HFE38U).

Start by figuring out how this example fits in with what you've done and plan to do -- you may want to start a whole new directory and R Project, but I'd suggest adding a new R Markdown file to the project we started last time. 
