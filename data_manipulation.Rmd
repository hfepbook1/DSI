...
The example below creates a new variable measuring the delay between `pd_ears` and `pd_walk`; modifies the existing `group` variable; and creates a weight gain variable.
```{r}
mutate(litters_data,
