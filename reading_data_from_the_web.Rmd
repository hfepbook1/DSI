...
**_Learning Assessment:_** [This page](https://www.amazon.com/Napoleon-Dynamite-Jon-Heder/product-reviews/B003MXB4FC/ref=cm_cr_arp_d_paging_btm_2?ie=UTF8&filterByStar=five_star&reviewerType=avp_only_reviews&pageNumber=2#reviews-filter-bar) contains the first 10 five-star reviews of the movie "Napoleon Dynamite". Use a process similar to the one above to extract the titles of the reviews. 

```{r, eval = FALSE, echo = FALSE}
url = "https://www.amazon.com/Napoleon-Dynamite-Jon-Heder/product-reviews/B003MXB4FC/ref=cm_cr_arp_d_paging_btm_2?ie=UTF8&filterByStar=five_star&reviewerType=avp_only_reviews&pageNumber=2#reviews-filter-bar"

nap_dyn_html = read_html(url)

review_titles = nap_dyn_html %>%
...
req = GET("http://swapi.co/api/people/1")
con = content(req)
con$results[[1]]
