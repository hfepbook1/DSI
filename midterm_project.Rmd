...
Study participants were recruited from 50 Head Start centers in northern Manhattan, the Bronx, and Brooklyn, in neighborhoods with high rates of pediatric asthma. Researchers used a survey instrument to collect data on the child’s age, sex, asthma symptoms and other medical conditions, family-related factors, and features of the home environment.  Field staff measured the child’s height, weight, and skin-fold thicknesses. The staff then attached the accelerometer to the child’s non-dominant wrist with a hospital band. From the accelerometer data, we observe minute-by-minute activity data over 24 hours. Data are aggregated into 10-minute epochs by averaging across minutes in 10-minute intervals.
