...
Note about default RStudio treatment of RMD. They turn on previews -- behaves like a notebook. I don't like this (and i don't think i'm the [only one](https://twitter.com/hspter/status/793552089771233280)), but I might just be old. These can be turned off using preferences > R Markdown > Show output inline

### Basic RMD

Below is a first RMD file.
