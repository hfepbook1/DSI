...
This assignment reinforces ideas in [Data Wrangling II](topic_data_wrangling_ii.html). 
...
Your solutions to Problems 1+ should be included in your .Rmd file, and your submission for this assignment will be a zip file of the directory named `p8105_hw5_YOURUNI`. 
...
Subway stations in NYC have multiple entrances; data on [this page](https://dev.socrata.com/foundry/data.ny.gov/hvwh-qtfg) contains information on the entrances for each station. 
...
The code below will scrape the 1000 most recent reviews of the movie "Napoleon Dynamite" from Amazon. You can download the dataset this code produces [here](./data/dynamite_reviews.csv) -- scraping in this way can get your IP address flagged by Amazon's algorithms that prevent large numbers of requests from a single computer.
