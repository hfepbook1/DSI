...
These all did something I didn't want, but only two returned errors. To avoid behavior you don't want (i.e. to fail loudly) we'll add some checks on the argument values using conditional statements.
