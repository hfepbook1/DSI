...
Next we'll convert `ind` to a factor variable with a character label, make a quick plot, and fit a linear model using `ind` as a predictor and `insulin` as the outcome. 
