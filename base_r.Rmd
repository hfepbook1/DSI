...
Launch R Studio and take stock -- find the Console, the Environment/History, and the
...
Note, in the preceding, that we overwrote the previous assignment to `r`. 
