...
The version of the Mr. Trash Wheel data we'll use for this class is available [here](./data/HealthyHarborWaterWheelTotals2017-3.xlsx). 

**UPDATE:** a more recent dataset is [here](./data/HealthyHarborWaterWheelTotals2017-9-26.xlsx).


## Context

[Mr. Trash Wheel](http://baltimorewaterfront.com/healthy-harbor/water-wheel/) is "a [water-wheel vessel](https://en.wikipedia.org/wiki/Mr._Trash_Wheel) that removes trash from the Inner Harbor in Baltimore, Maryland." It (or he) sits at an intake into the Inner Harbor and intercepts litter and debris carried by the Jones Falls River toward the harbor. It has removed over a million pounds of litter since May 2014!
